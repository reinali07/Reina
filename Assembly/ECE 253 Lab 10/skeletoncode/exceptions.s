...
/*
REGISTERS USED IN IRQ:
    EXCEPTIONS:   TIMER_ISR:                             KEY_ISR:
R0: SUBROUTINE   /TIMER ADDRESS /LEDR_DIRECTION ADDRESS /KEY ADDRESS              /TIMER ADDRESS
R1: SUBROUTINE   /TIMER F BIT   /LEDR_PATTERN ADDRESS   /EDGE CAPTURE BIT         /READ N WRITE TIMER CONTROL
R2: SUBROUTINE                  /LEDR_DIRECTION
R3: SUBROUTINE                  /LEDR_PATTERN           /MASK TO CHECK WHICH KEY  /MASK TO XOR TIMER CONTROL
R4: GIC                         /UPPER BIT
R5: INTERRUPT ID                /LOWER BIT
/*
...
PRIV_TIMER_CHECK:
                ...
                BL PRIV_TIMER_ISR //GO TO TIMER HANDLER
                B EXIT_IRQ //ONLY ONE INTERRUPT OCCURED
    
KEYS_CHECK:
    			CMP R5, #73 //CHECK FOR KEY INTERRUPT
